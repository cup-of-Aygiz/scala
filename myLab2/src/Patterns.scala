object PatternMatching {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(testWinsA(Paper, Paper))
    val firstFish = new Fish("Mackerel", Meat)
    val firstMammal = new Mammal("Person", Meat,56)
    print("e) ")
    println(testExtractMammalWeight(firstFish))
    println(testExtractMammalWeight(firstMammal))
    print("f) ")
    println(testUpdateFood(firstFish).food)
    println(testUpdateFood(firstMammal).food)
